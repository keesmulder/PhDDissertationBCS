...
\chapter{Proof of variance overestimation using the aoristic fraction method} \label{proofvar}
...
\section{Data on the real line} \label{proofreal}
...
\section{Aoristic data} \label{aoproof}
...
\chapter{Von Mises based Dirichlet Process Mixture model} \label{dpmdetails}
...
\chapter{Rejection sampling aoristic data} \label{rejsampling}
...
\chapter{Prior independent of $\mu_0$} \label{margprior}
