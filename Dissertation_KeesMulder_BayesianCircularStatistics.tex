...
\end{knitrout}
\caption{Birthdays of our group of friends (black dots), and average birthday (dotted line) progression  for our group of friends, as friends keep arriving.}
...
\end{knitrout}
\caption{On the circle, the circular mean (straight line) of the sample of birthdays (black dots)  is a natural central tendency.}
...
\footnote{This chapter is published as Mulder, K., \& Klugkist, I. (2017). Bayesian estimation and hypothesis tests for a circular Generalized Linear Model. \textit{Journal of Mathematical Psychology, 80}, 4–14.
